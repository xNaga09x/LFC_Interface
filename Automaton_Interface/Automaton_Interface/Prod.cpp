...
Prod::Prod(const int& overStackSize, const int& initState, const int& finalState, const char& alphabet, const char& topStack, const std::vector<char>& overStack)
...
void Prod::setOverStack(const std::vector<char>& characters)
{
...
std::vector<char> Prod::getOverStack() const
{
	return m_overStack;
}
